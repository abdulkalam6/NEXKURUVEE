...
function(t, e, i, s) {
    ...
    n.Defaults = {
        nav: !1,
        navText: ['<span aria-hidden="true" aria-label="Previous">&#x2039;</span><span class="visually-hidden">Previous</span>', '<span aria-hidden="true" aria-label="Next">&#x203a;</span><span class="visually-hidden">Next</span>'],
        navSpeed: !1,
        navElement: 'button aria-label="Carousel navigation" type="button" role="presentation"',
        navContainer: !1,
...
function(t, e, i, s) {
    ...
    l.csstransitions() && (t.support.transition = new String(o("transition")), t.support.transition.end = h.transition.end[t.support.transition]), l.cssanimations() && (t.support.animation = new String(o("animation")), t.support.animation.end = h.animation.end[t.support.animation]), l.csstransforms() && (t.support.transform = new String(o("transform")), t.support.transform3d = l.csstransforms3d())
}(window.Zepto || window.jQuery, window, document), jQuery(".services-carousel").owlCarousel({
        loop: !1,
        margin: 15,
        dots: !1,
        nav: !0,
    ...
    }), jQuery(".included-carousel").owlCarousel({
        loop: !1,
        nav: !0,
        dots: !1,
        margin: 15,
    ...
    }), jQuery(".influencer-carousel").owlCarousel({
        loop: !1,
        margin: 15,
        dots: !1,
        nav: !0,
        ...
        jQuery(window).scrollTop() > 350 ? jQuery(".scrolled-show").removeClass("animate__slideOutDown").addClass("animate__slideInUp").addClass("animate__animated").removeClass("d-none") : jQuery(".scrolled-show.animate__slideInUp").addClass("animate__slideOutDown").removeClass("d-none")
    }),
    function() {
        var t, e;

        function i() {
            t = document.querySelectorAll(".animated"), e = window.innerHeight
        }

        function s() {
            for (var i = 0; i < t.length; i++) {
                var s = t[i];
                t[i].getBoundingClientRect().top - e <= 0 && (s.classList.add("animate-element"), s.classList.remove("hidden"))
            }
        }
        window.addEventListener("scroll", s), window.addEventListener("resize", i), i(), s()
    }();